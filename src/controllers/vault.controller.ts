...
export async function getVaultEntryController(request: Request, response: Response, next: NextFunction): Promise<void> {
  try { response.json(await getEntry(requireUser(request.user), parseUuid(request.params.entryId))); } catch (error) { next(error); }
}
...
export async function updateVaultEntryController(request: Request, response: Response, next: NextFunction): Promise<void> {
  try { response.json(await updateEntry(requireUser(request.user), parseUuid(request.params.entryId), request.body)); } catch (error) { next(error); }
}

export async function archiveVaultEntryController(request: Request, response: Response, next: NextFunction): Promise<void> {
  try { await archiveEntry(requireUser(request.user), parseUuid(request.params.entryId)); response.status(204).send(); } catch (error) { next(error); }
}

export async function deleteVaultEntryController(request: Request, response: Response, next: NextFunction): Promise<void> {
  try { await deleteEntry(requireUser(request.user), parseUuid(request.params.entryId)); response.status(204).send(); } catch (error) { next(error); }
}

export async function getVaultEntryTagsController(request: Request, response: Response, next: NextFunction): Promise<void> {
  try { response.json(await getEntryTags(requireUser(request.user), parseUuid(request.params.entryId))); } catch (error) { next(error); }
}

export async function setVaultEntryTagsController(request: Request, response: Response, next: NextFunction): Promise<void> {
  try { response.json(await setEntryTags(requireUser(request.user), parseUuid(request.params.entryId), request.body)); } catch (error) { next(error); }
}

export async function revealVaultSecretController(request: Request, response: Response, next: NextFunction): Promise<void> {
  try {
    const result = await revealSecret(requireUser(request.user), parseUuid(request.params.entryId));
