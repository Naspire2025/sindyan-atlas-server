...
import { getMemberSummaryController, getUserController, listInvitationsController, listUsersController, updateOwnPreferencesController, updateUserController } from '../controllers/user.controller';
...
userRouter.patch('/me/preferences', requireAuth, updateOwnPreferencesController);
